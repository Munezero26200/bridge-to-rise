    ...
    return (
        <div className="bg-blue-100 flex flex-col items-center justify-center">
           <div className="bg-white rounded-lg p-8 mt-10 flex flex-col items-center w-full max-w-xl">
            <h1 className="text-4xl font-bold font-serif text-black text-center mt-10">Youth Credentials</h1>
            {/* form */}
            <div className="flex justify-center mt-10">
                <form className="flex flex-col space-y-4 w-96">
                   ...
                   <input type="text" placeholder="BackGround Education" className="border border-gray-300 rounded-md p-2 " />
                    <input type="text" placeholder="career of interest" className="border border-gray-300 rounded-md p-2 " />
